...
const defaultIssues = [
  ...
  },
  {
    ...
    deskripsiMasalah:
      "Masa pembayaran sudah lewat namun mahasiswa belum membayar karena masalah teknis bank.",
  ...
  },
  {
    ...
    kategori: "Akun/SSO",
    deskripsiMasalah:
      "Mohon dicek kenapa akun sering terkunci sendiri tanpa sebab yang jelas.",
    klasifikasi: "Pengaduan",
    urgensi: "Low",
    status: "DITOLAK",
    deadline: "21 - 04 - 2026",
    alasanDitolak:
      "Harap melampirkan screenshot pesan error, karena log sistem tidak menunjukkan anomali.",
    assignment: {
      sistemInformasi: "SSO Undiksha",
...
const UrgencyBadge = ({ urgency }) => {
  ...
  if (urgency === "High")
    bgColors = "bg-orange-50 text-orange-600 border-orange-200";
  else if (urgency === "Medium")
    bgColors = "bg-yellow-50 text-yellow-700 border-yellow-200";
  else if (urgency === "Normal")
    bgColors = "bg-teal-50 text-teal-600 border-teal-200";
  else if (urgency === "Evaluasi")
    bgColors = "bg-indigo-50 text-indigo-600 border-indigo-200";
  else if (urgency === "Pending")
    bgColors = "bg-gray-100 text-gray-600 border-gray-300";
  else if (urgency === "Urgent")
    bgColors = "bg-red-50 text-red-600 border-red-200";
  else if (urgency === "Critical")
    bgColors = "bg-red-100 text-red-800 border-red-400 font-bold";

  return (
    <div
      className={`mt-1.5 inline-flex items-center mx-auto text-[9px] font-semibold px-2 py-0.5 rounded-full border ${bgColors}`}
    >
            ...
            <div className="overflow-x-auto border border-gray-200 rounded-sm">
              <table className="w-full text-sm text-left min-w-[1000px]">
                <thead className="bg-[#f8f9fa] text-gray-800 border-b border-gray-200">
                  <tr>
                    <th className="px-4 py-4 font-bold text-center border-r border-gray-200">
                      ID
                    </th>
                    <th className="px-4 py-4 font-bold text-center border-r border-gray-200">
                      Tanggal
                    ...
                    filteredIssues.map((issue, idx) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-5 text-center border-r border-gray-200">
                          {(() => {
                            const isString =
                              typeof issue.assignment === "string";
                        ...
                        <td className="px-4 py-5 text-center">
                          <div className="flex items-center justify-center gap-1.5 flex-wrap w-[76px] mx-auto">
                            <button
                              ...
                              className="w-8 h-8 rounded bg-[#ffcc00] hover:bg-[#e6b800] text-white flex items-center justify-center transition-colors cursor-pointer"
                              title="Edit"
                            >
                            ...
                            <button
                              onClick={() =>
                                router.push(`/issue/${issue.id}/detail`)
                              }
                              className="w-8 h-8 rounded bg-[#2196f3] hover:bg-[#1976d2] text-white flex items-center justify-center transition-colors cursor-pointer"
                              title="Detail"
                            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
          <div className="bg-white w-full max-w-3xl rounded-sm shadow-xl flex flex-col max-h-[90vh]">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <h2 className="text-gray-800 font-bold text-lg uppercase tracking-wide">
                Penugasan Ke Unit Tujuan
              </h2>
              <button
                onClick={closePenugasanModal}
            ...
            <div className="p-6 md:p-8 overflow-y-auto w-full">
              <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-8">
                  <label className="text-gray-800 font-medium text-[15px] w-full md:w-40 shrink-0 md:mt-2">
                    Unit Tujuan
                  </label>
                  <div className="flex-1 w-full">
                    <div className="relative border-b border-gray-400">
                      <select
                        value={penugasanForm.unitTujuan}
                        onChange={(e) =>
                          setPenugasanForm({
                            ...penugasanForm,
                            unitTujuan: e.target.value,
                          })
                        }
                    ...
                    <p className="text-[12px] text-gray-400 mt-1 italic">
                      *Unit Tujuan dapat dipilih lebih dari satu
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex-1 w-full">
                    <div className="relative border-b border-gray-400">
                      ...
                      >
                        ...
                        <option value="Made Agus Panji Sujaya, S.Pd">
                          Made Agus Panji Sujaya, S.Pd
                        </option>
                        <option value="Komang Aditya Pratama, S.Pd">
                          Komang Aditya Pratama, S.Pd
                        </option>
                        <option value="Luh Setiani, S.Pd., M.Pd.">
                          Luh Setiani, S.Pd., M.Pd.
                        </option>
                        <option value="I Nyoman Arya Yudiharta, A.Md">
                    ...
                    <p className="text-[12px] text-gray-400 mt-1 italic">
                      *Petugas dapat dipilih lebih dari satu
                    </p>
                  </div>
                </div>
                ...
                {/* Catatan */}
                <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-8">
                  <label className="text-gray-800 font-medium text-15px w-40 shrink-0 mt-2">
                    Catatan
                  </label>
                  <div className="flex-1 w-full">
                    <p className="text-[12px] text-gray-400 mb-2 italic">
                      *Deskripsikan laporan yang diterima
                    </p>
                    <textarea
